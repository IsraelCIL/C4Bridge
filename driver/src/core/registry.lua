...
function Registry.securityList()
    local partitions = {}
...
function Registry.counts()
    ...
    for _, device in pairs(Registry.devices) do
        ...
        if device.supported then
            ...
            elseif device.kind == "security" then
                supportedSecurity = supportedSecurity + 1
            end
        end
    end
    ...
    return {
        ...
        supported_security = supportedSecurity,
    }
end
