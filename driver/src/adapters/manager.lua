...
local Security = require("src.adapters.security")
...
local registry = nil
local logger = nil
local initializedCounts = { total = 0, light = 0, climate = 0, security = 0 }
...
function Manager.initialize(deviceRegistry, logFunction)
    ...
    logger = logFunction
    attached = {}
    initializedCounts = { total = 0, light = 0, climate = 0, security = 0 }
...
function Manager.counts()
    return {
        ...
        security = initializedCounts.security,
    }
end
